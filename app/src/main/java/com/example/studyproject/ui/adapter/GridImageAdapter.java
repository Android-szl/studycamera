package com.example.studyproject.ui.adapter;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                Drawable drawable = ContextCompat.getDrawable(context, com.luck.picture.lib.R.drawable.picture_audio);
                assert drawable != null;
                StringUtils.modifyTextViewDrawable(viewHolder.tv_duration, drawable, 0);
            } else {
                Drawable drawable = ContextCompat.getDrawable(context, com.luck.picture.lib.R.drawable.video_icon);
                assert drawable != null;
                StringUtils.modifyTextViewDrawable(viewHolder.tv_duration, drawable, 0);
            }
            viewHolder.tv_duration.setText(DateUtils.timeParse(duration));
            if (mimeType == PictureMimeType.ofAudio()) {
                viewHolder.mImg.setImageResource(com.luck.picture.lib.R.drawable.audio_placeholder);
            } else {
